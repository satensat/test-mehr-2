...
import ClockBoldIcon from "@/icon2/ClockBold";
        ...
        <div className="flex flex-col px-3 pb-3  z-[10] md:w-[70%] ">
          <div className="flex flex-col gap-3  py-3  h-full md:relative     rounded-3xl ">
            ...
            <div className=" text-sm font-normal leading-6 text-[#525252] max-w-[900px]">
              شرایط و قوانین استفاده از وب‌سایت در واقع مجموعه ای از قواعد و
              مقررات است که کاربران و بازدیدکنندگان یک سایت قبل از دسترسی به
              کالاها و خدمات آن سایت می بایست با این شرایط و قوانین موافقت
              نمایند.
            </div>
          </div>
          ...
          <div className="flex flex-row  items-center p-3 bg-[#f7f7f7] rounded-2xl gap-3  max-w-[900px] ">
            ...
            <div className="flex flex-col">
              <div className=" text-[#808080] text-xs leading-6 font-bold ">
                اخرین تاریخ به روز رسانی
              </div>
              <div className=" text-[#242424] text-xs leading-5 font-costumFaNum  ">
                1402/02/21
              </div>
            </div>
