...
import MessagesIcon from "@/icon2/MessagesIcon";
import WalletCheck from "@/icon2/WalletCheck";
import PercentTageSquareIcon from "@/icon2/PercentTageSquare";

export default function AgencyReceiveBenefits() {
  return (
    <>
      <div className="flex flex-col">
        ...
        <div className="p-3 flex flex-col gap-3">
          ...
          <div className=" bg-[#fdfdfd] rounded-xl flex flex-row px-3 py-2 gap-2">
            ...
            <div className="text-right text-xs not-italic font-normal leading-5 text-[#242424]">
              ارتباط مستقیم با مدیران فروش سازمان
            </div>
          </div>
          <div className=" bg-[#fdfdfd] rounded-xl flex flex-row px-3 py-2 gap-2">
            <div>
            ...
            <div className="text-right text-xs not-italic font-normal leading-5 text-[#242424]">
              اطلاعات به‌روز شده از آخرین قیمت‌های محصولات شرکت
            </div>
          </div>
        </div>
      </div>
      <div className="pt-0 md:pt-3 pb-0 md:pb-5 ">
        <div className=" flex flex-col px-3 before:bg-[#E6E6E6] md:before:h-[0px] before:content-['']  before:h-[1px] before:w-full ">
          <div className="py-3 md:py-2 flex flex-row gap-2">
            <div>
              <ClipBoardTickIcon />
            </div>
            <div className="text-right text-sm not-italic font-bold leading-6  text-[#242424]">
        ...
        <div className="pt-3 px-3 md:p-3 flex flex-col gap-3">
