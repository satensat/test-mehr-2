      ...
      >
        <div className="flex flex-col relative items-center justify-center ">
          ...
          <div className=" flex flex-col px-3 pb-3 gap-3">
            <div className="text-[#ffff] leading-6 text-base font-bold text-center cursor-pointer ">
              از شرکت شما در نظرسنجی بینهایت متشکریم
            </div>
            <div className=" text-[#ffff] leading-8 text-base text-center cursor-pointer "> 
